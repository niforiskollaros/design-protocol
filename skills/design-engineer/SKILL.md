...
description: Audit code for accessibility violations, component quality, and implementation consistency. Use after /ux and /ui for building — this skill reviews what's been built. Phase 4 of DSP workflow. Trigger with "/design-engineer [file or component]" to get a structured code review with severity levels and specific fixes.
---
...
At the start of any `/design-engineer` invocation:
...
- **After building** — Review implementations created with /ux and /ui guidance
...
### Last Activity
- **Date:** [TIMESTAMP]
- **Action:** Completed review phase with /design-engineer
- **Quality Score:** 78/100
...
3. [ ] Re-run /design-engineer to verify fixes
